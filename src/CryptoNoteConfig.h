...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x106cf9;
...
const char     CRYPTONOTE_NAME[]                             = "inrcoin";
...
const int      P2P_DEFAULT_PORT                              = 12721;
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              = 12821;
